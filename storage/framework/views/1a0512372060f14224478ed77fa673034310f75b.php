            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="project-card bg-white rounded-lg overflow-hidden shadow-md transition duration-300">
                    <div class="relative overflow-hidden h-48">
                        <img src="<?php echo e(asset('docs/rcc1.PNG')); ?>" alt="Projet Laravel" class="w-full h-full object-cover">
                ...
                <div class="project-card bg-white rounded-lg overflow-hidden shadow-md transition duration-300">
                    <div class="relative overflow-hidden h-48">
                        <img src=" <?php echo e(asset('docs/rcc2.PNG')); ?> " alt="Projet Laravel" class="w-full h-full object-cover">
                        <div class="absolute inset-0 bg-indigo-600 opacity-0 hover:opacity-90 flex items-center justify-center transition duration-300">
                            <a href="#" class="text-white font-medium px-4 py-2 border border-white rounded hover:bg-white hover:text-indigo-600 transition duration-300">Voir le projet</a>
                        </div>
                    </div>
                ...
                <div class="project-card bg-white rounded-lg overflow-hidden shadow-md transition duration-300">
                    <div class="relative overflow-hidden h-48">
                        <img src=" <?php echo e(asset('docs/rcc3.PNG')); ?> " alt="Projet Laravel" class="w-full h-full object-cover">
                        <div class="absolute inset-0 bg-indigo-600 opacity-0 hover:opacity-90 flex items-center justify-center transition duration-300">
                            <a href="#" class="text-white font-medium px-4 py-2 border border-white rounded hover:bg-white hover:text-indigo-600 transition duration-300">Voir le projet</a>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\personal_backgrd\portfolio\resources\views/sections/project.blade.php ENDPATH**/ ?>